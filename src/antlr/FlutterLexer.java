...
public class FlutterLexer extends FlutterLexerBase {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FAB", "FAB_", "ONCD", "BORDER", "STYLE", "HINTTXT", "DECORATION", "TXTFLD", 
			"TXTBTN", "INDEC", "NAV", "PUSH", "BUILDER", "MPR", "INT", "CONST_", 
			"RUNAPP_", "MATERIALAPP_", "HOME_", "BODY_", "CHILDREN_", "SCAFFOLD_", 
